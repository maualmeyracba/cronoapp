"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[897],{84442:function(e,t,r){r.d(t,{D:function(){return signOut},ac:function(){return signInWithEmailAndPassword},p:function(){return getAuth},z:function(){return onAuthStateChanged}});var i=r(6771),n=r(99711),s=r(44645),a=r(75);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let o=_prodErrorMap,l=new n.LL("auth","Firebase",_prodErrorMap()),c=new s.Yd("@firebase/auth");function _logWarn(e,...t){c.logLevel<=s.in.WARN&&c.warn(`Auth (${i.Jn}): ${e}`,...t)}function _logError(e,...t){c.logLevel<=s.in.ERROR&&c.error(`Auth (${i.Jn}): ${e}`,...t)}/**
 * @license
